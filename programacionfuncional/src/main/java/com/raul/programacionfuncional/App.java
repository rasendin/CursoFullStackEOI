package com.raul.programacionfuncional;
...
import com.raul.programacionfuncional.entidades.Usuario;
...
public class App 
{
	...
	/*
	 * Skip sirve para saltar resultados
	 * Limit sirve para limitar el número de resultados
	 */
	public static void skipYLimit() {
		// No son finales
		
		// Ejercicio: Saca los usuarios 3,4 y 5 que más ganan de la empresa
		usuarios.stream()
			...
			.limit(3)	// Coge a 3 entre los que quedan
			.forEach(e->System.out.println(e));
	}
	...
	public static void distinct() {
		...
		// Ejemplo: ¿Cuántos usuarios distintos hay?
		System.out.println("El número de usuarios distintos es: " + usuarios.stream().distinct().count());
		
		// Ejemplo: Obten una lista a partir de la original eliminando los duplicados
		List<Usuario> usuariosDistintos = usuarios.stream()
		.distinct()
		.collect(Collectors.toList());
		
		// Ejemplo: Dime los distintos sueldos que hay en la empresa
		...
		//Ejemplo: Dime los diferentes nombres de los empledaos
	...
	public static void summarizingDouble() {
		...
		System.out.println("Numero: " + estadisticas.getCount());
	}
	...
	public static void reduce() {
		...
		// Ejemplo: Multiplica todos los Id's
		int idsMultiplicados = usuarios.stream()
			.mapToInt(e->e.getId())
			.reduce(1, (a,b)->a*b);
		System.out.println("La multiplicación de los id's es: " + idsMultiplicados);
		
		// Ejemplo: Crea una variable con todos los nombres de los usuarios, uno en cada línea
	...
	public static void joining() {
		// Final
		String nombresDistintosMinusculasSeparadosPorComas = usuarios.stream()
				.map(e->e.getNombre().toLowerCase().substring(0, 2))
				.distinct()
				.sorted()
				.collect(Collectors.joining(", "));
		System.out.println(nombresDistintosMinusculasSeparadosPorComas);
	}
	...
	public static void parallelStream() {
		...
		System.out.println("El tiempo de la operación ha sido: " + (tiempoFinal-tiempoInicial) + "ms");
		
		// En paralelo
		tiempoInicial = System.currentTimeMillis();
		usuarios.parallelStream().forEach(e->convertirMayusculas(e.getNombre()));
		tiempoFinal = System.currentTimeMillis();
		System.out.println("El tiempo de la operación en paralelo ha sido: " + (tiempoFinal-tiempoInicial) + "ms");
	}
	
	public static String convertirMayusculas(String nombre) {
		// Método que simula una operación que tarda un segundo y pico en realizarse	
		try {
